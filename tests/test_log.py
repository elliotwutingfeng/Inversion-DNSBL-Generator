...
def test_init_logger():
    ...
    assert os.mkdir.received_args[0] == "logs", "Attempt to create 'logs' folder should be made"

    assert logging.getLevelName(logger.getEffectiveLevel()) == "INFO", "Logging level should be 'INFO'"
